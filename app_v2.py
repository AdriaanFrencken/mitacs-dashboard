...
with st.sidebar:
    ...
    grid_spacing = st.slider('Grid spacing (seconds)', min_value=0.01, max_value=1.0, value=0.2, step=0.1)
...
if uploaded_files:
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            title_font=dict(size=30),  # Increase axis label font size
            tickfont=dict(size=24),    # Increase tick label font size
